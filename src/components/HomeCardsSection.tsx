...
function CardColumn({ cards, title }: { cards: CardItem[], title: string }) {
  return (
    <div className="flex flex-col gap-6">
      <h2 className="text-lg font-semibold text-purple-800 text-center bg-white border border-purple-200 rounded-xl px-4 py-3 shadow-sm w-full dark:bg-gray-800 dark:border-purple-700 dark:text-white">
        {title}
      </h2>

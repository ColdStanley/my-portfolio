...
export default function AICardStudio() {
  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-white dark:bg-neutral-900 lakers:bg-gradient-to-br lakers:from-lakers-800 lakers:to-lakers-700 anno:bg-gradient-to-br anno:from-anno-900 anno:to-anno-800 pt-16 px-6 pb-0">
        <div className="max-w-full mx-auto">
          {/* Header Navigation Bar */}
          <div className="flex items-center justify-between mb-6">
            {/* Left side - Title */}
            <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 lakers:from-lakers-300 lakers:to-lakers-400 anno:from-anno-300 anno:to-anno-400 bg-clip-text text-transparent">
              AI Card Studio
            </h1>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="px-4 py-2 bg-white dark:bg-neutral-800 lakers:bg-lakers-300/20 anno:bg-anno-700/20 border border-purple-200 dark:border-purple-700 lakers:border-lakers-300 anno:border-anno-300 text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 lakers:hover:bg-lakers-300/30 anno:hover:bg-anno-300/20 rounded-lg font-medium transition-all duration-200 flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-sm text-gray-500 dark:text-neutral-400 lakers:text-lakers-300 anno:text-anno-300">
                {isSaving ? (
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4 animate-spin text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300" fill="none" viewBox="0 0 24 24">
                      <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/>
                      <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
                    </svg>
                    <span className="text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300">Saving...</span>
                  </div>
                ) : hasUnsavedChanges ? (
                  <span className="text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300">Unsaved changes</span>
                ) : (
                  <span className="text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300">All saved</span>
                )}
              </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center gap-2 relative ${
                  hasUnsavedChanges && !isSaving
                    ? 'bg-purple-600 hover:bg-purple-700 lakers:bg-lakers-300 lakers:hover:bg-lakers-400 anno:bg-anno-600 anno:hover:bg-anno-700 text-white shadow-lg hover:shadow-xl animate-pulse-urgent'
                    : 'bg-gray-100 dark:bg-neutral-700 lakers:bg-lakers-700/50 anno:bg-anno-800/50 text-gray-400 dark:text-neutral-500 lakers:text-lakers-200 anno:text-anno-200 cursor-not-allowed'
                }`}
                style={{
                  ...(hasUnsavedChanges && !isSaving && {
              ...
              <div className="relative" data-dropdown-container>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-neutral-800 lakers:bg-lakers-300/20 anno:bg-anno-700/20 border border-purple-200 dark:border-purple-700 lakers:border-lakers-300 anno:border-anno-300 rounded-lg text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300 font-medium hover:bg-purple-50 dark:hover:bg-purple-900/20 lakers:hover:bg-lakers-300/30 anno:hover:bg-anno-300/20 transition-all duration-200 min-w-[200px] justify-between"
                >
                ...
                {/* Dropdown Menu */}
                {dropdownOpen && (
                  <div className="absolute top-full mt-2 left-0 z-50 bg-white dark:bg-neutral-800 lakers:bg-lakers-700 anno:bg-anno-800 rounded-lg shadow-xl border border-gray-200 dark:border-neutral-700 lakers:border-lakers-300/30 anno:border-anno-300/30 p-2 min-w-[200px]">
                    {/* Arrow pointing to button */}
                    <div className="absolute -top-1 left-4 w-2 h-2 bg-white dark:bg-neutral-800 lakers:bg-lakers-700 anno:bg-anno-800 border-l border-t border-gray-200 dark:border-neutral-700 lakers:border-lakers-300/30 anno:border-anno-300/30 transform rotate-45"></div>
                    ...
                    {canvases.map((canvas) => (
                      <button
                        ...
                        className={`w-full px-3 py-2 text-sm rounded-md transition-all duration-150 text-left ${
                          canvas.id === activeCanvasId 
                            ? 'text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300 bg-purple-50 dark:bg-purple-900/50 lakers:bg-lakers-300/30 anno:bg-anno-300/30' 
                            : 'text-gray-600 dark:text-neutral-300 lakers:text-lakers-300 anno:text-anno-300 hover:text-purple-600 dark:hover:text-purple-400 lakers:hover:text-lakers-300 anno:hover:text-anno-300 hover:bg-purple-50 dark:hover:bg-purple-900/50 lakers:hover:bg-lakers-300/20 anno:hover:bg-anno-300/20'
                        }`}
                      >
                        {canvas.name}
                      </button>
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 text-sm text-left text-gray-600 dark:text-neutral-300 lakers:text-lakers-300 anno:text-anno-300 hover:text-purple-600 dark:hover:text-purple-400 lakers:hover:text-lakers-300 anno:hover:text-anno-300 hover:bg-purple-50 dark:hover:bg-purple-900/50 lakers:hover:bg-lakers-300/20 anno:hover:bg-anno-300/20 rounded-md transition-all duration-150 flex items-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={addCanvas}
                className="w-10 h-10 bg-white dark:bg-neutral-800 lakers:bg-lakers-300/20 anno:bg-anno-700/20 border border-purple-200 lakers:border-lakers-300 anno:border-anno-300 text-purple-600 dark:text-purple-400 lakers:text-lakers-300 anno:text-anno-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 lakers:hover:bg-lakers-300/30 anno:hover:bg-anno-300/20 rounded-lg flex items-center justify-center transition-all duration-200"

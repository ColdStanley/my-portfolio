...
export default function CanvasSettingsModal({ isOpen, onClose, canvasId }: CanvasSettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ref={modalRef}
        className="bg-[var(--surface)] backdrop-blur-md rounded-xl shadow-xl border border-white/20 p-6 w-96 max-w-sm mx-4"
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent"
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={handleSave}
                className="px-4 py-2 text-sm bg-[var(--primary)] hover:bg-purple-700 text-white rounded-lg transition-all duration-150"
              >
                Save
              </button>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm bg-[var(--primary)] hover:bg-purple-700 text-white rounded-md transition-all duration-150"
                >
                  Delete
                </button>
              </div>

          ...
          {user ? (
            <div className="relative">
              ...
              <div ref={userMenuRef} className="fixed top-4 right-4 z-50">
                ...
                {/* Dropdown menu */}
                {showUserMenu && (
                  <div className="absolute top-full right-0 mt-2 w-48 bg-white/95 backdrop-blur-md rounded-lg shadow-xl border border-gray-200 py-2">
                    <div className="px-3 py-2 text-xs text-gray-500 border-b border-gray-100">
                      Signed in as
                    </div>
                    <div className="px-3 py-1 text-sm text-gray-700 truncate">
                      {user.email}
                    </div>

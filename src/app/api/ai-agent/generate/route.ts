  ...
  try {
    ...
    const completion = await modelConfig.client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a helpful AI assistant. Provide clear, accurate, and useful responses. Follow the user's instructions precisely."
        },
        {
          role: "user",
          content: prompt
    ...
    // Create a ReadableStream for streaming response (similar to Readlingua)

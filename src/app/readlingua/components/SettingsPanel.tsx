          ...
          >
            ...
            <div className="mb-4">
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-primary hover:bg-primary hover:brightness-110 text-white rounded-lg font-medium whitespace-nowrap flex items-center justify-center gap-2 transition-all"
              >

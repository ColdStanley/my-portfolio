...
import NewQuestionKeywordSelector from '../custom-answer/components/NewQuestionKeywordSelector'
import NewKeywordAndInput from '../custom-answer/components/NewKeywordAndInput'
import NewAnswerDisplayCustom from '../custom-answer/components/NewAnswerDisplayCustom'
import NewIELTSCustomHeader from '../custom-answer/components/NewIELTSCustomHeader'
import UpgradeModal from '../custom-answer/components/UpgradeModal'
import { useAnswerCounter } from '@/hooks/useAnswerCounter'
import { useCurrentUserType } from '@/hooks/useCurrentUserType'
import { usePathname, useRouter } from 'next/navigation'

export default function CustomAnswerView() {
  ...
  return (
<main className="flex-1 flex flex-col justify-start gap-4 p-6 max-w-7xl mx-auto scroll-smooth text-base">
      ...
      {keywords.length > 0 ? (
        <>
          ...
          {!counterLoading && (
            <div className="text-sm bg-purple-50 border border-purple-200 text-purple-800 py-2 px-4 rounded-xl shadow-sm text-center">
        ...
        <div className="p-6 sm:p-8 border border-dashed rounded-2xl bg-purple-50/70 text-purple-900 text-base leading-relaxed shadow-sm transition">
      ...
      {answers && (
        <>
          ...
          <div className="text-sm text-gray-700 leading-relaxed bg-purple-50 p-4 rounded-xl shadow-inner border border-purple-200">

    ...
    <div className="flex h-full flex-col gap-6 p-6">
      ...
      <div className="flex flex-1 gap-3 md:gap-6">
        ...
        <div className="flex w-1/2 items-center justify-center">
          <div
            className={`grid w-full gap-2 md:gap-4 ${
              currentWords.length <= 4 ? 'grid-cols-2 md:grid-cols-4' : 'grid-cols-2 md:grid-cols-4 md:grid-rows-2'
            }`}
        ...
        <div className="flex w-1/2 items-center justify-center">
          <div
            className={`grid w-full gap-2 md:gap-4 ${
              shuffledWords.length <= 4 ? 'grid-cols-2 md:grid-cols-4' : 'grid-cols-2 md:grid-cols-4 md:grid-rows-2'
            }`}
            style={{ perspective: '1000px' }}
          >
